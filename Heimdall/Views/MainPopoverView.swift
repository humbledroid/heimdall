...
struct MainPopoverView: View {
    ...
    var body: some View {
        ...
        .task {
            ...
            // Start event-driven USB monitoring for devices
            // (this is NOT polling — it uses adb track-devices which
            // only fires when a device is actually connected/disconnected)
